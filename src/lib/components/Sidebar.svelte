...
<div
	class="z-10 will-change-transform transition-transform sm:transition-none sm:transform-none h-screen top-0 fixed sm:h-auto sm:relative sm:flex-[2] sm:flex min-w-48 max-w-80 bg-base-300 dark:bg-base-200"
